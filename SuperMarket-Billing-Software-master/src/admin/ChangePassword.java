...
public class ChangePassword extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 100, 860, 430));
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        boolean status =  dbOperations.checkOldPassword(old_pass,"abhinav123@gmail.com");
        if(status ){
        if(new_pass.equals(cnew_pass)){
            boolean status2 =   dbOperations.updatePassword(new_pass,"abhinav123@gmail.com");
            if(status2){
                ...
                jTextField3.setText("");
                 ...
                 JOptionPane.showMessageDialog(rootPane,"Password did not updated ","Error",JOptionPane.ERROR_MESSAGE);
            }
        }else{
             JOptionPane.showMessageDialog(rootPane,"new Password did not matched ","RError",JOptionPane.ERROR_MESSAGE);
        }
        }
        else{
